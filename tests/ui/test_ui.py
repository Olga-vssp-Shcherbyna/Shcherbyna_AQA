...
def test_check_incorrect_username():
    ...
    driver = webdriver.Chrome(
        service=Service(r"C:\Users\o.shcherbyna\Shcherbyna_AQA" + "chromedriver.exe")
    )
    ...
    login_elem.send_keys("olhashcherbyna@mistakeinemail.com")
